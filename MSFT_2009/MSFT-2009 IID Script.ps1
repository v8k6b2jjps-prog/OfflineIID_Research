...
Write-Host
Write-Host "--- Msft C# Dll Recover Results ---" -ForegroundColor Yellow
Write-Host

$last = $BinKey.CdKey.Substring(24, 5)
$candidates = [msft]::Recover($generatedIid, $last)
$candidates | % {
    $newKey = [BinaryKey]::new($binKey.Group, $binKey.Serial, $_, $true, $true)
